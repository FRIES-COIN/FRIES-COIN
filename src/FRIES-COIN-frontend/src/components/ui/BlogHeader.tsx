...
function BlogHeader() {
  return (
    <div className="flex flex-col items-center md:items-end md:flex-row md:justify-between mt-8 mx-4 border-b border-gray-200 pb-8">
      <div className="flex flex-col">
        ...
        <h1 className="text-2xl font-rem font-bold mt-4 text-gray-200">
          Stay Ahead in the Ever-Changing World of $FRYS
        </h1>
